  ...
  return (
    <div className="relative flex flex-col items-center cursor-pointer">
      <img
        ...
        src={member.image}
        alt={member.name}
        className="w-10 h-10 md:w-36 md:h-44 object-cover"
      />

      <div
        className={`absolute top-8 border md:top-0 md:w-36 md:h-44 backdrop-blur-lg bg-opacity-60 bg-blue-500 text-white text-center transform transition-all duration-500 ease-in-out ${
